...
//
// 		config := log.Config{}
// 		config.Raft.StreamLayer = raft.NewStreamLayer(ln, nil, nil)
...
// 		}
//
// 		l, err := raft.NewDistributedLog(dataDir, config)
// 		require.NoError(t, err)
//
// 		if i != 0 {
...
// 	require.IsType(t, server.ErrOffsetOutOfRange{}, err)
